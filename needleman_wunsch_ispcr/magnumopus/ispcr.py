...
def ispcr(primer_file_path, assembly_file_path, max_amplicon_size) -> str:
    sorted_hits = step_one(primer_file_path, assembly_file_path)

    hits_pairs = step_two(sorted_hits, max_amplicon_size)

    amplicons = step_three(hits_pairs, assembly_file_path)
